...
<section id="app-bot-settings" class="hidden">
  ...
  <form action="" class="space-y-4 hidden" id="bot-settings-form">
    ...
    <div>
      ...
      <input class="input" type="text" name="name" id="bot-name" autocomplete="off">
      <div id="name-error-display" class="text-red-500"></div>
    </div>
    <div>
      <label class="block text-sm font-medium" for="bot-platform">Platform</label>
      <input class="input" type="text" name="platform" id="bot-platform" autocomplete="off" disabled>
    </div>
    <div>
...
<section id="app-bot-features" class="hidden">
  ...
  <template id="feature-card-template">
    <div class="feature-card flex flex-col mt-2 bg-gray-900 text-white border-[1px] border-gray-700 shadow-lg p-4 rounded-md mb-4 min-w-[280px] max-w-[380px] flex-1">
      <div class="mb-2">
        <label class="block text-sm font-medium mb-1" for="feature-select">Feature</label>
        <select name="feature-select" class="w-full p-2 bg-gray-700 text-white rounded"></select>
      </div>
      <div class="mb-2">
        <label class="block text-sm font-medium mb-1" for="trigger-input">Trigger</label>
...
<section id="app-account" class="hidden">
  ...
  <form action="" class="space-y-4" id="account-settings-form">
    ...
    <div id="account-settings-password-inputs" class="hidden">
      ...
      <input class="input" type="password" name="password" id="account-section-password" autocomplete="current-password" disabled>
      ...
      <input class="input" type="password" name="confirmPassword" id="account-section-password-confirm" autocomplete="current-password" disabled>
  ...
  <div class="mt-4 space-y-4">
    ...
    <div>
      <form>
        ...
        <input class="input" type="password" name="twitchToken" id="account-section-twitchToken" autocomplete="off">
      </form>
    </div>
    <div>
      <form>
        ...
        <input class="input" type="password" name="openAiKey" id="account-section-openAiKey" autocomplete="off">
      </form>
    </div>
  </div>
</section>
